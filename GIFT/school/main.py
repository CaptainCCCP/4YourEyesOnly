...
face = cv2.CascadeClassifier(r'Q:\Anaconda\Lib\haarcascades\haarcascade_frontalface_default.xml')
eye =  cv2.CascadeClassifier(r'Q:\Anaconda\Lib\haarcascades\haarcascade_eye.xml')
smile = cv2.CascadeClassifier(r'Q:\Anaconda\Lib\haarcascades\haarcascade_smile.xml')
while(1):
    ret,frame = cap.read()
